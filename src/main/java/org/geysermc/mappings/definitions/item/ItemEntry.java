...
public record ItemEntry(Identifier bedrockIdentifier, int bedrockData, boolean isBlock,
                        int firstBlockRuntimeId, int lastBlockRuntimeId, boolean entityPlacer, int fuelDuration) {
    public static final Codec<ItemEntry> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    Codec.INT.optionalFieldOf("fuel_duration", 0).forGetter(ItemEntry::fuelDuration)
    ...
    public ItemEntry(Identifier bedrockIdentifier, int bedrockData) {
        this(bedrockIdentifier, bedrockData, false, -1, -1, false, 0);
    }
}
