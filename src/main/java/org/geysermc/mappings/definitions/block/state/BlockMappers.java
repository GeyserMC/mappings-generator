package org.geysermc.mappings.definitions.block.state;
...
import static org.geysermc.mappings.definitions.block.state.BlockMapper.addToTag;
import static org.geysermc.mappings.definitions.block.state.BlockMapper.register;
    ...
    public static void registerMappers() {
        ...
        register(Blocks.JIGSAW).addMapper((state, tag) -> {
            ...
            switch (value) {
                ...
                default -> throw new IllegalStateException("Unexpected value in jigsaw block: " + MappingsUtil.blockStateToString(state));
            }
